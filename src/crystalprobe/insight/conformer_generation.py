    ...
    *,
    ...
    for index, molecule in enumerate(molecules):
        try:
            ...
            total_charge = int(Chem.GetFormalCharge(mol))
            xyz_path = ""
            ...
            if write_xyz_dir is not None:
                ...
                atomic_write_text(
                    ...
                    xyz_text(
                        symbols, coordinates,
                        comment=f"{molecule.molecule_id} generated by RDKit ETKDGv3 charge={total_charge}",
                    ),
                )
            ...
            rows.append(
                _row(
                    ...
                    xyz_path=xyz_path,
                    metrics={**_coordinate_metrics(coordinates), "total_charge": total_charge},
                )
            )
